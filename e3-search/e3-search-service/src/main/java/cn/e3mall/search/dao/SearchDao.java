	...
	public SearchResult search(SolrQuery query) throws Exception{
		/*
			...
			for (SolrDocument doc : list) {
				...
				item.setCname((String)doc.get("item_category_name"));
				List<String> tlist = hl.get(doc.get("id")).get("item_title");
				String title="";
		...
		//根据查询条件查询索引库
				...
				for (SolrDocument solrDocument : solrDocumentList) {
					...
					searchItem.setCname(((String) solrDocument.get("item_category_name")));
